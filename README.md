# PHP Apache API with PostgreSQL

A simple PHP Apache API application and PostgreSQL, containerized with Docker.
...
```bash
git clone https://github.com/opsnoopop/api_php_apache_postgresql.git
```

### 2. Navigate to Project Directory
```bash
cd api_php_apache_postgresql
```
