...
export default function () {
  ...
  let res = http.post("http://container_php:80/users", JSON.stringify(body), headers);
...
export function handleSummary(data) {
  ...
  return {
    [filename]: htmlReport(data, {
      title: "5_constant_create_user_api_php_apache_postgresql_" + year + month + day + "_" + hours + minutes + seconds
    }),
  };
}